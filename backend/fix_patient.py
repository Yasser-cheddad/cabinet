# This script will fix the patient assignment issue in views.py
import re
...
# Fix the patient assignment in create_appointment
...
# Fix the patient assignment in create_appointment_patient
...
print("Fixed patient assignment issue in views.py")
